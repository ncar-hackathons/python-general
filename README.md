...
```bash
jupyter-book build python-general/
```
...
- Use the links specified in the `_data/toc.yml` file (pointing to files in `/content/`) and do the following:
  ...
  - Place all these generated files in the `python-general/_build/`
...
docker run --rm --security-opt label:disable  \
   -v /full/path/to/your/python-general:/srv/jekyll \
   -p 4000:4000 \
   -it -u 1000:1000 \
   emdupre/jupyter-book bundle exec jekyll serve --host 0.0.0.0
```

If you navigate to http://0.0.0.0:4000/python-general/ in your browser, you should see a preview copy of the site. 
